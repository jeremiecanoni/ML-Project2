...
np.save('Processed_Data/lem_data'+str(n), lem_data)
np.save('Processed_Data/lem_data_test' + str(n_test), lem_data_test)
np.save('Processed_Data/labels_train' + str(n), labels)
